...
def create_item_endpoint(
    version_id: str, data: CreateItem, current_user: dict = Depends(require_editor)
):
    ownership.own_version(version_id, current_user)
...
def update_item_endpoint(
    item_id: str, data: UpdateItem, current_user: dict = Depends(require_editor)
):
...
def reorder_items_endpoint(
    version_id: str, data: ReorderItems, current_user: dict = Depends(require_editor)
):
    ownership.own_version(version_id, current_user)
