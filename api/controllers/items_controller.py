...
def create_item_endpoint(version_id: str, data: CreateItem, current_user: dict = Depends(get_current_user)):
...
def update_item_endpoint(item_id: str, data: UpdateItem, current_user: dict = Depends(get_current_user)):
...
def delete_item_endpoint(item_id: str, current_user: dict = Depends(get_current_user)):
...
def reorder_items_endpoint(version_id: str, data: ReorderItems, current_user: dict = Depends(get_current_user)):
