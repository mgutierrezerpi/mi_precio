  ...
  return (
    <div className="dash flex h-screen overflow-hidden bg-[var(--dash-bg)] font-sans text-[var(--dash-text)]">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <CrmTopbar title={title} subtitle={subtitle} searchPlaceholder={searchPlaceholder} searchValue={searchValue} onSearchChange={onSearchChange} onSearchSubmit={onSearchSubmit} actions={actions} />
