...
import type { ChecklistItem } from '../../../lib/onboardingTour'
import { Icon } from './ui'
...
export function FirstStepsView({
  ...
  return (
    <section
      ...
      className={[
        'flex flex-col gap-3 rounded-[var(--dash-radius)] border border-[var(--dash-border)]',
        'bg-[var(--dash-surface)] p-4 transition-opacity duration-500 ease-out motion-reduce:transition-none md:p-5',
...
function StepRow({ item, t }: { item: ChecklistItem; t: Translate }) {
