    ...
    <div className="min-h-screen bg-[var(--color-bg-primary)] flex flex-col transition-colors">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <StepCard
              number="I"
              title="Sube tu lista"
              description="Arrastra fotos, PDFs o archivos Excel con tus precios."
            />
            <StepCard
              number="II"
              title="Personaliza"
              description="Ajusta colores, logo y organiza tus productos."
            />
            <StepCard
              number="III"
              title="Comparte"
              description="Genera tu código QR único para tus clientes."
            />
            <StepCard
              number="IV"
              title="Actualiza"
              description="Modifica precios cuando quieras, se reflejan al instante."
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-8">
            <IntegrationCard
              icon={<MapIcon />}
              name="Google Maps"
              description="Importa datos de tu negocio"
            />
            <IntegrationCard
              icon={<LinkedinIcon />}
              name="LinkedIn"
            ...
            <IntegrationCard
              icon={<FacebookIcon />}
              name="Facebook"
              description="Optimiza tu página"
            />
            <IntegrationCard
              icon={<InstagramIcon />}
              name="Instagram"
              description="Comparte tu lista"
            />
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-[var(--color-border)] py-12 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-[var(--color-text-muted)] text-sm">
            © {new Date().getFullYear()} Mi Precio. Todos los derechos
            reservados.
          </p>
        </div>
      </footer>
...
function FormatCard({
  ...
  return (
    <div
      className={`flex items-center gap-4 p-4 bg-[var(--color-bg-card)] border ${highlighted ? 'border-[var(--color-accent)]' : 'border-[var(--color-border)]'} rounded`}
    >
