...
const Package = ({ className, size = 22 }: IcoProps) =>
  line(
    size,
    className,
    <>
...
const Link2 = ({ className, size = 22 }: IcoProps) =>
  line(
    size,
    className,
    <>
...
const QrCode = ({ className, size = 22 }: IcoProps) =>
  line(
    size,
    className,
    <>
...
const DollarSign = ({ className, size = 22 }: IcoProps) =>
  line(
    size,
    className,
    <>
...
const CircleCheck = ({ className, size = 20 }: IcoProps) =>
  line(
    size,
    className,
    <>
...
const Check = ({ className, size = 18 }: IcoProps) =>
  line(size, className, <path d="M20 6 9 17l-5-5" />)
const Sparkles = ({ className, size = 14 }: IcoProps) =>
  line(
    size,
    className,
    <>
...
const ArrowRight = ({ className, size = 18 }: IcoProps) =>
  line(
    size,
    className,
    <>
...
const Plus = ({ className, size = 20 }: IcoProps) =>
  line(
    size,
    className,
    <>
