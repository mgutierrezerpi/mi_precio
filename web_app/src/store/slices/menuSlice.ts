...
export const createItem = createAsyncThunk(
  'menu/createItem',
  async ({ versionId, data }: { versionId: string; data: { name: string; price: number; description?: string; category?: string; imageUrl?: string; productId?: string } }, { rejectWithValue }) => {
