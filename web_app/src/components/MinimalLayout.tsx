...
const headerClass = [
  'sticky top-0 z-20 flex items-center justify-between p-4 md:p-6',
  'bg-[var(--color-bg-primary)]/80 backdrop-blur-sm border-b border-[var(--color-border)]',
].join(' ')
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg-primary)] transition-colors">
      ...
      <header className={headerClass}>
        <Link to="/admin" className={panelLinkClass}>
