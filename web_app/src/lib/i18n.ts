...
const DICT: Record<string, Entry> = {
  ...
  'side.planTag': { es: 'PLAN INICIAL', en: 'STARTER PLAN', pt: 'PLANO INICIAL' },
  'side.upgradeTitle': { es: 'Subí a Pyme', en: 'Upgrade to Pyme', pt: 'Assine o Pyme' },
  'side.upgradeDesc': { es: 'Productos ilimitados y multiusuario.', en: 'Unlimited products and multi-user.', pt: 'Produtos ilimitados e multiusuário.' },
  ...
  'bill.recommended': { es: 'Recomendado', en: 'Recommended', pt: 'Recomendado' },
  ...
  'bill.perMonth': { es: '/ mes', en: '/ month', pt: '/ mês' },
  'bill.plan.free': { es: 'Gratis', en: 'Free', pt: 'Grátis' },
  'bill.plan.pyme': { es: 'Pyme', en: 'Pyme', pt: 'Pyme' },
  'bill.plan.pro': { es: 'Pro', en: 'Pro', pt: 'Pro' },
  'bill.price.free': { es: '$0', en: '$0', pt: '$0' },
  'bill.price.pyme': { es: '$390', en: '$390', pt: '$390' },
  'bill.price.pro': { es: '$890', en: '$890', pt: '$890' },
  'bill.tagline.free': { es: 'Para empezar a publicar tu catálogo.', en: 'To start publishing your catalog.', pt: 'Para começar a publicar seu catálogo.' },
  'bill.tagline.pyme': { es: 'Para negocios en crecimiento con equipo.', en: 'For growing businesses with a team.', pt: 'Para negócios em crescimento com equipe.' },
  'bill.tagline.pro': { es: 'Sin límites, para operaciones grandes.', en: 'No limits, for large operations.', pt: 'Sem limites, para grandes operações.' },
