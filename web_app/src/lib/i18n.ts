...
const DICT: Record<string, Entry> = {
  ...
  'set.brand.colorSub': { es: 'Se usa en acentos, botones y el carrito.', en: 'Used for accents, buttons and the cart.', pt: 'Usada em destaques, botões e no carrinho.' },
  'set.hero.title': { es: 'Color del hero', en: 'Hero color', pt: 'Cor do hero' },
  'set.hero.subtitle': { es: 'Color del encabezado destacado. Si lo dejás vacío usa el color de marca.', en: 'Color of the featured header. Leave empty to use the brand color.', pt: 'Cor do cabeçalho em destaque. Deixe vazio para usar a cor da marca.' },
  'set.hero.useBrand': { es: 'Usar color de marca', en: 'Use brand color', pt: 'Usar cor da marca' },
  ...
  'set.design.classic.desc': { es: 'Lista de precios prolija por categorías.', en: 'Tidy price list grouped by category.', pt: 'Lista de preços organizada por categoria.' },
  'set.design.nordic.name': { es: 'Menú nórdico', en: 'Nordic menu', pt: 'Menu nórdico' },
  'set.design.nordic.desc': { es: 'Papel claro, tipografía serif, estilo carta.', en: 'Light paper, serif type, menu style.', pt: 'Papel claro, tipografia serifada, estilo cardápio.' },
  'set.design.fine.name': { es: 'Fine dining', en: 'Fine dining', pt: 'Fine dining' },
  'set.design.fine.desc': { es: 'Elegante y oscuro, con detalles dorados.', en: 'Elegant and dark, with gold accents.', pt: 'Elegante e escuro, com detalhes dourados.' },
  'set.design.modern.name': { es: 'Marca moderna', en: 'Modern brand', pt: 'Marca moderna' },
  'set.design.modern.desc': { es: 'Blanco, tipografía grande y franja de color.', en: 'White, bold type and a color band.', pt: 'Branco, tipografia grande e faixa de cor.' },
  'set.design.photo.name': { es: 'Lookbook con fotos', en: 'Photo lookbook', pt: 'Lookbook com fotos' },
  'set.design.photo.desc': { es: 'Oscuro y visual, con fotos de tus productos.', en: 'Dark and visual, with your product photos.', pt: 'Escuro e visual, com fotos dos seus produtos.' },
  'set.design.cards.name': { es: 'Tarjetas de precios', en: 'Price cards', pt: 'Cartões de preços' },
  'set.design.cards.desc': { es: 'Cuadrícula de tarjetas, ideal para servicios.', en: 'Grid of cards, great for services.', pt: 'Grade de cartões, ideal para serviços.' },
  'set.design.catalog.name': { es: 'Catálogo con imágenes', en: 'Image catalog', pt: 'Catálogo com imagens' },
  ...
  'set.bg.change': { es: 'Cambiar imagen', en: 'Change image', pt: 'Trocar imagem' },
  'set.bg.overlay': { es: 'Filtro con color de marca', en: 'Brand color filter', pt: 'Filtro com cor da marca' },
  'set.bg.overlayDesc': { es: 'Aplica una capa con tu color de marca sobre la imagen.', en: 'Lays your brand color over the image.', pt: 'Aplica uma camada com a cor da marca sobre a imagem.' },
